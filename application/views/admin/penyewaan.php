...
<div class="table-responsive">
	<table class="table table-bordered table-striped table-hover" id="table-datatable">
		...
		<tbody>
			...
			<tr>
				<td><?php echo $no++; ?></td>
				<td><?php echo $p->nama_pengunjung; ?></td>
				<td><?php echo $p->nama_kamar; ?></td>
				<td><?php echo $p->no_kamar; ?></td>
				<td><?php echo date('d/m/Y',strtotime($p->tgl_checkin)); ?></td>
				<td><?php echo date('d/m/Y',strtotime($p->tgl_checkout)); ?></td>
				<td><?php echo "Rp. ".number_format($p->harga_kamar).",-"; ?></td>
